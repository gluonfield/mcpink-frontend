...
export type MeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, email: string | null | undefined, displayName: string | null | undefined, githubUsername: string | null | undefined, avatarUrl: string | null | undefined, createdAt: string, githubAppInstallationId: string | null | undefined, githubScopes: Array<string> } | null | undefined };

export type MyApiKeysQueryVariables = Exact<{ [key: string]: never; }>;


export type MyApiKeysQuery = { __typename?: 'Query', myAPIKeys: Array<{ __typename?: 'APIKey', id: string, name: string, prefix: string, lastUsedAt: string | null | undefined, createdAt: string }> };
...
export type CreateApiKeyMutation = { __typename?: 'Mutation', createAPIKey: { __typename?: 'CreateAPIKeyResult', secret: string, apiKey: { __typename?: 'APIKey', id: string, name: string, prefix: string, createdAt: string } } };
...
export type RecheckGithubAppInstallationMutation = { __typename?: 'Mutation', recheckGithubAppInstallation: string | null | undefined };
...
export type ProjectDetailsQuery = { __typename?: 'Query', projectDetails: { __typename?: 'Project', id: string, name: string, ref: string, createdAt: string, updatedAt: string, services: Array<{ __typename?: 'Service', id: string, name: string | null | undefined, repo: string, branch: string, errorMessage: string | null | undefined, fqdn: string | null | undefined, memory: string, vcpus: string, createdAt: string, updatedAt: string, status: { __typename?: 'ServiceStatus', build: string, runtime: string } }> } | null | undefined };
...
export type ListServicesQuery = { __typename?: 'Query', listServices: { __typename?: 'ServiceConnection', totalCount: number, nodes: Array<{ __typename?: 'Service', id: string, name: string | null | undefined, repo: string, branch: string, errorMessage: string | null | undefined, fqdn: string | null | undefined, memory: string, vcpus: string, createdAt: string, updatedAt: string, status: { __typename?: 'ServiceStatus', build: string, runtime: string } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null | undefined, endCursor: string | null | undefined } } };
...
export type ServiceDetailsQuery = { __typename?: 'Query', serviceDetails: { __typename?: 'Service', id: string, name: string | null | undefined, repo: string, branch: string, errorMessage: string | null | undefined, fqdn: string | null | undefined, port: string, gitProvider: string, commitHash: string | null | undefined, memory: string, vcpus: string, customDomain: string | null | undefined, customDomainStatus: string | null | undefined, createdAt: string, updatedAt: string, status: { __typename?: 'ServiceStatus', build: string, runtime: string }, envVars: Array<{ __typename?: 'EnvVar', key: string, value: string }> } | null | undefined };
...
export type ServiceMetricsQuery = { __typename?: 'Query', serviceMetrics: { __typename?: 'ServiceMetrics', memoryLimitMB: number, cpuLimitVCPUs: number, cpuUsage: { __typename?: 'MetricSeries', metric: string, dataPoints: Array<{ __typename?: 'MetricDataPoint', timestamp: string, value: number }> }, memoryUsageMB: { __typename?: 'MetricSeries', metric: string, dataPoints: Array<{ __typename?: 'MetricDataPoint', timestamp: string, value: number }> }, networkReceiveBytesPerSec: { __typename?: 'MetricSeries', metric: string, dataPoints: Array<{ __typename?: 'MetricDataPoint', timestamp: string, value: number }> }, networkTransmitBytesPerSec: { __typename?: 'MetricSeries', metric: string, dataPoints: Array<{ __typename?: 'MetricDataPoint', timestamp: string, value: number }> } } };

export type ListDelegatedZonesQueryVariables = Exact<{ [key: string]: never; }>;


export type ListDelegatedZonesQuery = { __typename?: 'Query', listDelegatedZones: Array<{ __typename?: 'DelegatedZone', id: string, zone: string, status: string, error: string | null | undefined, createdAt: string, dnsRecords: Array<{ __typename?: 'DNSRecord', host: string, type: string, value: string, verified: boolean }> | null | undefined }> };
...
export type DelegateZoneMutation = { __typename?: 'Mutation', delegateZone: { __typename?: 'DelegateZoneResult', zoneId: string, zone: string, status: string, dnsRecords: Array<{ __typename?: 'DNSRecord', host: string, type: string, value: string, verified: boolean }> } };
...
export type VerifyDelegationMutation = { __typename?: 'Mutation', verifyDelegation: { __typename?: 'VerifyDelegationResult', zoneId: string, zone: string, status: string, message: string, dnsRecords: Array<{ __typename?: 'DNSRecord', host: string, type: string, value: string, verified: boolean }> } };
...
export type RemoveDelegationMutation = { __typename?: 'Mutation', removeDelegation: { __typename?: 'RemoveDelegationResult', zoneId: string, message: string } };
...
export const RecheckGithubAppInstallationDocument = gql`
  ...
  recheckGithubAppInstallation
    ...
    `;
export type RecheckGithubAppInstallationMutationFn = ApolloReactCommon.MutationFunction<RecheckGithubAppInstallationMutation, RecheckGithubAppInstallationMutationVariables>;
 ...
 * });
 */
export function useRecheckGithubAppInstallationMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RecheckGithubAppInstallationMutation, RecheckGithubAppInstallationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<RecheckGithubAppInstallationMutation, RecheckGithubAppInstallationMutationVariables>(RecheckGithubAppInstallationDocument, options);
      }
export type RecheckGithubAppInstallationMutationHookResult = ReturnType<typeof useRecheckGithubAppInstallationMutation>;
export type RecheckGithubAppInstallationMutationResult = ApolloReactCommon.MutationResult<RecheckGithubAppInstallationMutation>;
export type RecheckGithubAppInstallationMutationOptions = ApolloReactCommon.BaseMutationOptions<RecheckGithubAppInstallationMutation, RecheckGithubAppInstallationMutationVariables>;
...
export function useListProjectsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<ListProjectsQuery, ListProjectsQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<ListProjectsQuery, ListProjectsQueryVariables>(ListProjectsDocument, options);
        }
 ...
 * });
 */
export function useProjectDetailsQuery(baseOptions: ApolloReactHooks.QueryHookOptions<ProjectDetailsQuery, ProjectDetailsQueryVariables> & ({ variables: ProjectDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
export function useProjectDetailsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<ProjectDetailsQuery, ProjectDetailsQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<ProjectDetailsQuery, ProjectDetailsQueryVariables>(ProjectDetailsDocument, options);
        }
...
export type ProjectDetailsSuspenseQueryHookResult = ReturnType<typeof useProjectDetailsSuspenseQuery>;
 ...
 * });
 */
export function useServiceDetailsQuery(baseOptions: ApolloReactHooks.QueryHookOptions<ServiceDetailsQuery, ServiceDetailsQueryVariables> & ({ variables: ServiceDetailsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<ServiceDetailsQuery, ServiceDetailsQueryVariables>(ServiceDetailsDocument, options);
      }
export function useServiceDetailsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ServiceDetailsQuery, ServiceDetailsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<ServiceDetailsQuery, ServiceDetailsQueryVariables>(ServiceDetailsDocument, options);
        }
export function useServiceDetailsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<ServiceDetailsQuery, ServiceDetailsQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<ServiceDetailsQuery, ServiceDetailsQueryVariables>(ServiceDetailsDocument, options);
        }
...
export type ServiceDetailsSuspenseQueryHookResult = ReturnType<typeof useServiceDetailsSuspenseQuery>;
export type ServiceDetailsQueryResult = ApolloReactCommon.QueryResult<ServiceDetailsQuery, ServiceDetailsQueryVariables>;
 ...
 * });
 */
export function useServiceMetricsQuery(baseOptions: ApolloReactHooks.QueryHookOptions<ServiceMetricsQuery, ServiceMetricsQueryVariables> & ({ variables: ServiceMetricsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<ServiceMetricsQuery, ServiceMetricsQueryVariables>(ServiceMetricsDocument, options);
      }
export function useServiceMetricsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ServiceMetricsQuery, ServiceMetricsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<ServiceMetricsQuery, ServiceMetricsQueryVariables>(ServiceMetricsDocument, options);
        }
export function useServiceMetricsSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<ServiceMetricsQuery, ServiceMetricsQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<ServiceMetricsQuery, ServiceMetricsQueryVariables>(ServiceMetricsDocument, options);
        }
...
export type ServiceMetricsQueryResult = ApolloReactCommon.QueryResult<ServiceMetricsQuery, ServiceMetricsQueryVariables>;
 ...
 * });
 */
export function useListDelegatedZonesQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<ListDelegatedZonesQuery, ListDelegatedZonesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<ListDelegatedZonesQuery, ListDelegatedZonesQueryVariables>(ListDelegatedZonesDocument, options);
      }
export function useListDelegatedZonesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListDelegatedZonesQuery, ListDelegatedZonesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<ListDelegatedZonesQuery, ListDelegatedZonesQueryVariables>(ListDelegatedZonesDocument, options);
        }
export function useListDelegatedZonesSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<ListDelegatedZonesQuery, ListDelegatedZonesQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<ListDelegatedZonesQuery, ListDelegatedZonesQueryVariables>(ListDelegatedZonesDocument, options);
        }
export type ListDelegatedZonesQueryHookResult = ReturnType<typeof useListDelegatedZonesQuery>;
export type ListDelegatedZonesLazyQueryHookResult = ReturnType<typeof useListDelegatedZonesLazyQuery>;
export type ListDelegatedZonesSuspenseQueryHookResult = ReturnType<typeof useListDelegatedZonesSuspenseQuery>;
export type ListDelegatedZonesQueryResult = ApolloReactCommon.QueryResult<ListDelegatedZonesQuery, ListDelegatedZonesQueryVariables>;
export const DelegateZoneDocument = gql`
  ...
  delegateZone(zone: $zone) {
    ...
    `;
export type DelegateZoneMutationFn = ApolloReactCommon.MutationFunction<DelegateZoneMutation, DelegateZoneMutationVariables>;
 ...
 * });
 */
export function useDelegateZoneMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<DelegateZoneMutation, DelegateZoneMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<DelegateZoneMutation, DelegateZoneMutationVariables>(DelegateZoneDocument, options);
      }
...
export type DelegateZoneMutationOptions = ApolloReactCommon.BaseMutationOptions<DelegateZoneMutation, DelegateZoneMutationVariables>;
export const VerifyDelegationDocument = gql`
  ...
  verifyDelegation(zone: $zone) {
    ...
    `;
export type VerifyDelegationMutationFn = ApolloReactCommon.MutationFunction<VerifyDelegationMutation, VerifyDelegationMutationVariables>;
 ...
 * });
 */
export function useVerifyDelegationMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<VerifyDelegationMutation, VerifyDelegationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<VerifyDelegationMutation, VerifyDelegationMutationVariables>(VerifyDelegationDocument, options);
      }
export type VerifyDelegationMutationHookResult = ReturnType<typeof useVerifyDelegationMutation>;
export type VerifyDelegationMutationResult = ApolloReactCommon.MutationResult<VerifyDelegationMutation>;
export type VerifyDelegationMutationOptions = ApolloReactCommon.BaseMutationOptions<VerifyDelegationMutation, VerifyDelegationMutationVariables>;
export const RemoveDelegationDocument = gql`
  ...
  removeDelegation(zone: $zone) {
    ...
    `;
export type RemoveDelegationMutationFn = ApolloReactCommon.MutationFunction<RemoveDelegationMutation, RemoveDelegationMutationVariables>;
 ...
 * });
 */
export function useRemoveDelegationMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<RemoveDelegationMutation, RemoveDelegationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useMutation<RemoveDelegationMutation, RemoveDelegationMutationVariables>(RemoveDelegationDocument, options);
      }
export type RemoveDelegationMutationHookResult = ReturnType<typeof useRemoveDelegationMutation>;
export type RemoveDelegationMutationResult = ApolloReactCommon.MutationResult<RemoveDelegationMutation>;
export type RemoveDelegationMutationOptions = ApolloReactCommon.BaseMutationOptions<RemoveDelegationMutation, RemoveDelegationMutationVariables>;