...
export type ListProjectsQuery = { __typename?: 'Query', listProjects: { __typename?: 'ProjectConnection', totalCount: number, nodes: Array<{ __typename?: 'Project', id: string, name: string, ref: string, createdAt: string, updatedAt: string, services: Array<{ __typename?: 'Service', id: string, name: string | null | undefined, status: string }> }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null | undefined, endCursor: string | null | undefined } } };
...
export type ProjectDetailsQuery = { __typename?: 'Query', projectDetails: { __typename?: 'Project', id: string, name: string, ref: string, createdAt: string, updatedAt: string, services: Array<{ __typename?: 'Service', id: string, name: string | null | undefined, repo: string, branch: string, status: string, errorMessage: string | null | undefined, fqdn: string | null | undefined, createdAt: string, updatedAt: string }> } | null | undefined };
...
export type ListServicesQuery = { __typename?: 'Query', listServices: { __typename?: 'ServiceConnection', totalCount: number, nodes: Array<{ __typename?: 'Service', id: string, name: string | null | undefined, repo: string, branch: string, status: string, errorMessage: string | null | undefined, fqdn: string | null | undefined, memory: string, vcpus: string, createdAt: string, updatedAt: string }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null | undefined, endCursor: string | null | undefined } } };
...
export type ServiceDetailsQuery = { __typename?: 'Query', serviceDetails: { __typename?: 'Service', id: string, name: string | null | undefined, repo: string, branch: string, status: string, errorMessage: string | null | undefined, fqdn: string | null | undefined, port: string, gitProvider: string, commitHash: string | null | undefined, memory: string, vcpus: string, customDomain: string | null | undefined, customDomainStatus: string | null | undefined, createdAt: string, updatedAt: string, envVars: Array<{ __typename?: 'EnvVar', key: string, value: string }> } | null | undefined };
