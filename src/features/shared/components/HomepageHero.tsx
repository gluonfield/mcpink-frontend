  ...
  return (
    <main>
      ...
      <section className="px-3">
        <div className="relative mx-auto max-w-[1600px] overflow-hidden bg-neutral-950 px-6 py-60 md:py-88">
          {/* Background image */}
          <img
      ...
      {/* Works with marquee */}
      <section className="mx-auto max-w-[1600px] overflow-hidden bg-neutral-950 px-3 py-6">
      ...
      <section className="mx-auto mt-8 max-w-[1600px] bg-neutral-950 px-6 py-28 md:py-40">
        <div className="mx-auto max-w-4xl pl-4 md:pl-8">
